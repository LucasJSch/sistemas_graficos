...
function drawScene(panelsShader,
    ...
    gl.uniformMatrix4fv(earthShader.getModelMatrixPtr(), false, modelMatrix);
    gl.uniformMatrix4fv(earthShader.getViewMatrixPtr(), false, viewMatrix);
    gl.uniformMatrix4fv(earthShader.getProjMatrixPtr(), false, projMatrix);
    gl.uniformMatrix4fv(earthShader.getNormalMatrixPtr(), false, normalMatrix);
    ...
    var planet = new Planet(earthShader);
